[English](README.md) · [日本語](README-ja.md) · [繁體中文](README-zh-TW.md) · [Deutsch](README-de.md) · [Esperanto](README-eo.md) · Latina
...
Programma memoriae repetitionis (replay buffer) pro mensa Windows. Leve, parvi oneris, ab initio Rust conditum.  
...
Super Simple Highlighter, extensio Chrome ad textum illuminandum, valde aucta.  
...
`https://identity-vulpes.pages.dev/` / Nuntium relinque
...
<div align="right">
  <p>Lilium (versio Grissini Project)</p>
  <a href="https://www.youtube.com/watch?v=JvCpCg0sGkg" target="_blank" rel="noopener noreferrer">
    <img width="40%" src="https://img.youtube.com/vi/JvCpCg0sGkg/hqdefault.jpg" alt="Pelliculam in YouTube specta">
  </a>
</div>
