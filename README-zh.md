...
在终端中将 InfluxDB line protocol 绘制成图表，统计功能更强大（stats++）  
...
适用于 Windows 桌面的回放缓冲（replay buffer）软件。轻量、低开销，从设计上就以 Rust 打造。  
...
文字高亮 Chrome 扩展程序“Super Simple Highlighter”的超级增强版。  
...
`https://identity-vulpes.pages.dev/` / 给我留言
...
<details open>
<summary><h2>对 Vulpes 感兴趣吗？</h2></summary>
...
<div align="left">
  ...
  <a href="https://www.youtube.com/watch?v=L6QtByukIPs" target="_blank" rel="noopener noreferrer">
    <img width="40%" src="https://img.youtube.com/vi/L6QtByukIPs/hqdefault.jpg" alt="在 YouTube 上观看视频">
  </a>
</div>
