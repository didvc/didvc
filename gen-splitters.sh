...
render splitter-1.png 420 180 \
  -stroke "$(c .55)" -draw "line 60,70 1580,34" \
  -stroke "$(c .28)" -draw "line 520,-2 1560,82" \
  -stroke "$(c .16)" -draw "line 980,90 1590,58"

# 2: thin skewed triangle with drafting-style overshooting edges
render splitter-2.png 220 220 \
  -stroke "$(c .40)" -draw "line 1539,69 39,22" \
  -stroke "$(c .24)" -draw "line 299,6 519,90" \
  -stroke "$(c .16)" -draw "line 1459,64 199,86"
...
for spec in "80 60 1180 .45" "360 44 1540 .22" "240 76 900 .16" "620 30 1420 .30" "980 66 1580 .12"; do
  ...
  d3+=(-stroke "$(c $o)" -draw "line $x1,$y1 $x2,$y2")
done
